            ...
            with open(self.file_path, 'rb') as f:
                ...
                while pos < len(data):
                    ...
                    try:
                        ...
                        if key_size == 0 or key_size > 256:  # Reasonable size limit
                            pos += 1
                            continue
                        ...
                        if val_size == 0 or val_size > 1024:  # Reasonable size limit
                            pos += 1
                            continue
                        ...
                        # Process if key looks interesting
                        try:
                            ...
                            logger.debug(f'Error processing entry at position {pos}: {e}')
                            continue
...
def main():
    ...
    for filename in mmkv_files:
        ...
        if file_path.exists():
            ...
            header, file_type = analyzer.read_mmkv_header()
            if header:
